...
positive_vocabs = open("positive-words.txt","r").read()
negative_vocab = open("negative-words.txt","r").read()
documents = []
positive_words = positive_vocabs.split('\n')
positive_words = [positive_words[i] for i in range(35,2042)]
#positive_words.append('biometrics')   
negative_words = negative_vocab.split('\n')
negative_words = [negative_words[i] for i in range(35,4819)]   
